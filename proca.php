 ...
 */
function proca_civicrm_config(&$config) {
 ...
 */
function proca_civicrm_xmlMenu(&$files) {
 ...
 */
function proca_civicrm_install() {
 ...
 */
function proca_civicrm_postInstall() {
 ...
 */
function proca_civicrm_uninstall() {
 ...
 */
function proca_civicrm_disable() {
 ...
 */
function proca_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
 ...
 */
function proca_civicrm_managed(&$entities) {
 ...
 */
function proca_civicrm_caseTypes(&$caseTypes) {
 ...
 */
function proca_civicrm_angularModules(&$angularModules) {
 ...
 */
function proca_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
 ...
 */
function proca_civicrm_entityTypes(&$entityTypes) {
 ...
 */
function proca_civicrm_themes(&$themes) {
 ...
 */
//function proca_civicrm_preProcess($formName, &$form) {
//
//}
 ...
 */
//function proca_civicrm_navigationMenu(&$menu) {
